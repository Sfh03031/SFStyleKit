...
// MARK: Support SFExStyle for system Api of CALayer
public extension SFExStyle where Base: CALayer {
    ...
    @available(iOS 18.0, *)
    @discardableResult
    func toneMapMode(_ mode: CALayer.ToneMapMode) -> SFExStyle {
        base.toneMapMode = mode
        return self
    }
    ...
    @discardableResult 
    func actions(_ actions: [String: any CAAction]?) -> SFExStyle {
