...
public extension UIColor {
    ...
    /// Generate solid color images using colors
    var image: UIImage? {
...
// MARK: New static methods
public extension UIColor {
    
    /// Hexadecimal color by string
    /// - Parameter
    ///   - hex: Hexadecimal color string, with or without "#"
    ///   - alpha: [0, 1]
    /// - Returns: UIColor
    ...
    /// Hexadecimal color by number
    /// - Parameter hex: Hexadecimal color number, like 0xFF0000
    /// - Returns: UIColor
    ...
    static func RGB(R: Float, G: Float, B: Float, alpha: Float = 1) -> UIColor {
        return Self(red: CGFloat(R/255.0), green: CGFloat(G/255.0), blue: CGFloat(B/255.0), alpha: CGFloat(alpha))
    }
...
// MARK: chinese colors, source: `https://www.qijishow.com/Colors/color.html`
public extension UIColor {
    /// 丁香色
...
// MARK: Pantone Year colors, source: `https://www.qijishow.com/Colors/pantone.html`
public extension UIColor {
    
    /// 2025 - 阿尔卑斯燕麦色
    class var hex_PT_F0E7DA: UIColor { #colorLiteral(red: 0.9411764706, green: 0.9058823529, blue: 0.8549019608, alpha: 1) }
    /// 2025 - 泡菜绿
    class var hex_PT_4E6813: UIColor { #colorLiteral(red: 0.3058823529, green: 0.4078431373, blue: 0.07450980392, alpha: 1) }
    /// 2025 - 光环靛蓝
    class var hex_PT_B0A6DF: UIColor { #colorLiteral(red: 0.6901960784, green: 0.6509803922, blue: 0.8745098039, alpha: 1) }
    /// 2025 - 奶油黄
    class var hex_PT_FFEDA8: UIColor { #colorLiteral(red: 1, green: 0.9294117647, blue: 0.6588235294, alpha: 1) }
    /// 2025 - 樱桃红
    class var hex_PT_74070E: UIColor { #colorLiteral(red: 0.4549019608, green: 0.02745098039, blue: 0.05490196078, alpha: 1) }
